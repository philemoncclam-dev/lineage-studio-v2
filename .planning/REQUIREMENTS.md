...
- [ ] **SHELL-01**: A persistent left icon rail lists top-level destinations; adding a fifth destination requires no structural change
- [ ] **SHELL-02**: The canvas fills the remaining viewport; chrome recedes visually

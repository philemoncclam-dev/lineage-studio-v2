...
- [x] 02-09-PLAN.md — Honest re-scope of SHELL-05/06 graph-mode drill to Phase 4 + carry-forward todo; resolvePathSegments left staged (SHELL-05/06)
...
- [x] 03-01-PLAN.md — Backend evidence thread (D-12) + api.ts mirror + backward-compat tests (TRUST-02)
- [x] 03-02-PLAN.md — Frontend toolchain: @xyflow/react + dagre swap, xyflow jsdom mocks, tier-3 tokens

**Wave 2** *(blocked on Wave 1)*

- [x] 03-03-PLAN.md — Deterministic dagre layout + toXyflow handle mapping + ported trace (DAG-01/02/03/06/07)
- [x] 03-04-PLAN.md — Inspector ColumnCard + adapt evidence thread (DAG-05/TRUST-02)
- [x] 03-06-PLAN.md — Keyboard/AT roving-tabindex nav + freshness indicator (DAG-08/TRUST-03)
...
- [x] 03-07-PLAN.md — LineageDagView integration + route swap + delete legacy SVG view (DAG-03/04/06/08/TRUST-03)
...
| 3. Lineage DAG Canvas Rebuild | 7/7 | In Progress|  |

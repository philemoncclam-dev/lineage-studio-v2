...
// DAG for one table. Unlike the graph-mode routes, LineageView already
// accepts focusTable/focusColumn as props, so this route genuinely drives
// the view from the URL (path -> focusTable, ?col search -> focusColumn).
//
...
function LineageRouteComponent() {
  ...
  return <LineageView focusTable={focusTable} focusColumn={search.col} />
}
